...
<body>
	<div class="wrap">
        ...
        <div class="banner"> <h2>welcome , <?php echo $_SESSION["name"] ?> ... please fill the details</h2></div>
		<div class="">
			<div class="left">
                <div>
                    <ul>
                        <li><a class="active" href="#home">Form</a></li>
                        <li><a href="survey/index.html">map</a></li>
                    ...
                    <form action="school_data_insert.php" method="post">
                      ...
                      <hr>
                            <div class="ip1">
                              ...
                              <input style="color: red;" type="text" id="fname"  value="<?php echo $_SESSION["scid"] ?>" disabled name="a" placeholder="">
